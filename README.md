...
* **Euros dépensés** – fired for the amount spent (before tax) when an order is completed.
...
referrals displayed in the widget is computed from this table and their
`referral_count` is updated accordingly.
