...
<main id="site-content" class="site-content home-page">
  ...
  <section class="home-section home-section--panorama">
    <div class="home-section__inner">
      <section class="home-panorama surface-card" aria-labelledby="home-panorama-title">
        <header class="home-panorama__header">
          <span class="home-eyebrow">Expérience Customiizer</span>
          <h2 class="home-panorama__title" id="home-panorama-title">Tout vivre en un seul regard</h2>
