                ...
                <div class="modal-body">
                        ...
                        <div class="visual-header">
                                <div class="image-controls">
                                        ...
                                        <button id="bringForwardButton" class="align-button" title="Mettre au premier plan"><i class="fas fa-arrow-circle-up"></i></button>
                                        <button id="sendBackwardButton" class="align-button" title="Envoyer à l'arrière-plan"><i class="fas fa-arrow-circle-down"></i></button>
                ...
                <div class="filters">
                    <div class="filter-group" id="format-block">
                        <div class="filter-buttons" id="mainFormatFilters">
                            ...
                            <button id="filter-product-ratio" class="format-main" data-format="product">Produit en cours</button>
                            <button id="open-format-menu" class="format-main">Format</button>
                        </div>
                        <div id="formatOptions" class="format-dropdown">
                            <div id="standardFormatList" class="filter-buttons">
