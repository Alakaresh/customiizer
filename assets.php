...
function customiizer_enqueue_customize_assets() {
	...
	// ===============================
       ...
       wp_enqueue_style('background-generation-style', get_stylesheet_directory_uri() . '/styles/background_generation.css', [], $ver);
	...
	// ===============================
       ...
       wp_enqueue_script('generation-background', get_stylesheet_directory_uri() . '/js/utils/background_generation.js', ['jquery'], $ver, true);
